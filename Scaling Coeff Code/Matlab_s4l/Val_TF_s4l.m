...
%%%loading for file modification by c fawole
% load 't3_106_304_tipDemo.csv'
% tip2can_T.mag = t3_106_304_tipDemo(:,1)';
% tip2can_T.mag = fliplr(tip2can_T.mag);
% tip2can_T.phase = t3_106_304_tipDemo(:,2)';
% tip2can_T.phase = fliplr(tip2can_T.phase);


%original T data in the next two line
...
%original script in two lines below
