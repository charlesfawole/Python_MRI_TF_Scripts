function rlt = Val_Zig_304(p_coil,ratio, p_gel, p_place, p_TF, p_lead, dx_lead, dy_lead, dz_lead, grid_TF,polate_mode)
%% simulations
...
Zig_coor = load('ZigZag.txt');
path.Z.x = Zig_coor(:,1); path.Z.y = Zig_coor(:,2); path.Z.z = Zig_coor(:,3);
